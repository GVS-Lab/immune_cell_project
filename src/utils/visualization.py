...
def explore_slices_multichannel(data, cmap="gray"):
    ...
    def display_slice(plane=8, channel=0):
        ...
        show_plane(ax, data[plane, channel], title="Plane {}, channel {}".format(plane, channel), cmap=cmap)
...
def explore_slices_2_samples_multichannel(data, cmap="gray"):
    ...
    def display_slice(plane=8, channel=0):
        ...
        show_plane(ax[0], data[0][plane, channel], title="Plane {}, channel {}".format(plane, channel), cmap=cmap)
        show_plane(ax[1], data[1][plane, channel], title='Plane {}, channel {}'.format(plane, channel), cmap=cmap)
        plt.show()
